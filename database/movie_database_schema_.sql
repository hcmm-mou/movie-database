...
CREATE TABLE `my_ratings` (
  ...
  PRIMARY KEY (`row_id`),
  KEY `title_movie_idx` (`movie_id`),
  CONSTRAINT `fk_my_ratings_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`movie_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-07-11 19:50:25
